/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 36c70caaf09935d4b5b4820d3df67dbb)
// Runtime types generated with workerd@1.20260131.0 2025-05-06 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "Sandbox" | "SessionDO";
	}
	interface Env {
		claude_sessions: R2Bucket;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ANTHROPIC_API_KEY" | "API_TOKEN" | "AWS_ACCESS_KEY_ID" | "AWS_SECRET_ACCESS_KEY" | "CF_ACCOUNT_ID" | "ENVIRONMENT" | "JWT_SECRET" | "API_BASE_URL" | "INTERNAL_API_TOKEN">> {}
}
