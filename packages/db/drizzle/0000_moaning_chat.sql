CREATE TYPE "public"."company_role" AS ENUM('admin', 'member');--> statement-breakpoint
CREATE TYPE "public"."message_role" AS ENUM('user', 'assistant');--> statement-breakpoint
CREATE TYPE "public"."message_type" AS ENUM('message', 'permission_request', 'permission_response', 'question', 'question_answer');--> statement-breakpoint
